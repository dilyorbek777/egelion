...
export const metadata: Metadata = {
  title: {
    default: "Egelion - Connect, Share, Discover",
    template: "%s | Egelion",
  },
  description: "Egelion is a modern social platform where you can share posts, create stories, connect with friends, and discover trending content.",
  keywords: ["social media", "posts", "stories", "videos", "connect", "share", "discover"],
  authors: [{ name: "Egelion" }],
  creator: "Egelion",
  metadataBase: new URL("https://egelion.vercel.app"),
  openGraph: {
    type: "website",
    locale: "en_US",
    siteName: "Egelion",
