...
import { Sun, Moon, LogOut, Bell, ChevronRight, Pencil, Trash2, Clock, Film } from "lucide-react";
          ...
          <CardContent>
            <div className="flex items-center gap-4">
              {dbUser.profileImage ? (
                ...
                <div className="w-16 h-16 rounded-full bg-linear-to-br from-primary/20 to-primary/10 flex items-center justify-center text-xl font-bold text-primary border-2 border-border">
                  {dbUser.fullName[0]}
                </div>
              )}
